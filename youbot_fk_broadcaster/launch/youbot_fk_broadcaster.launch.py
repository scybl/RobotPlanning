...
def generate_launch_description():
    ...
    # c. Custom TF publisher node.
    fk_tf_broadcaster_node = Node(
        package='youbot_fk_broadcaster',
        executable='youbot_fk_tf_broadcaster',
        name='youbot_fk_tf_broadcaster'
    )
